...
module.exports = function inject(bot, options) {
	...
	bot.switch.getJoinableFromBotPosition = () => {
		const serverInfo = bot.hologram.getMatchingHologram(switcher.hologramPatterns.serverStatus)
		const serverInfoMatches = bot.hologram.getPatternMatches(serverInfo, switcher.hologramPatterns.serverStatus)

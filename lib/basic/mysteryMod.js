module.exports = function inject(bot, options) {
	const mysteryMod = bot.hostData['mysteryMod']

	bot.mysteryMod.subtitleMap = {}

	bot.on('misc:mysteryMod->user_subtitle', (subtitles) => {
		for (const subtitle of subtitles) {
			
			if (!bot.mysteryMod.subtitleMap[subtitle.targetId]) bot.mysteryMod.subtitleMap[subtitle.targetId] = {}

			bot.mysteryMod.subtitleMap[subtitle.targetId][subtitle.scale] = subtitle.text
		}
		console.log(bot.mysteryMod.subtitleMap)
	})

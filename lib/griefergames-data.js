    ...
    bot.on('windowOpen', (window) => {
        ...
        Object.keys(windowPatterns).forEach(windowPatternKey => {
            ...
            if (windowTitleMatch) {
                ...
                const hostDataKey = windowPatternKey.split(bot.patternHeadNameSeparator)[0]
                const hostData = bot.hostData[hostDataKey]
                const windowPattern = hostData.windows[windowPatternKey.split(bot.patternHeadNameSeparator)[1]]

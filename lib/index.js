...
module.exports = function inject(bot, options) {
    const hostData = require('mineflayer-griefergames-data')
    bot.hostData = hostData

    // to prevent losing bot.chat
    bot.chatNative = bot.chat
    
    Object.keys(hostData).forEach(hostDataObjName => {
        const hostDataObj = hostData[hostDataObjName]
        bot[hostDataObjName] = {}
    })
